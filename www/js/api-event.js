...
$.ajax(settings).done(function (response) {
  debugger;
    ...
    $("#eventInformation").text(`Event Name = ${response.Events[0].Name} ,

    Event Name : ${response.Events[0].Name} Event Name : ${response.Events[0].Name}
    `);
...
function getEventRegistrations(){
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://frozen-savannah-60393.herokuapp.com/event/getRegistrations",
  //"url": "http://localhost:3000/event/getEvent",
...
$.ajax(settings).done(function (response) {
  debugger;
    ...
    $("#eventInformation").text(`Registration Id = ${response[0].Id} `);
